...
stringValidators = (
    ...
    {'id':'isCommaSeparatedEmails',
        ...
        'title':'Is one or more E-Mail Addresses separated by commas',
        'errmsg':'This is not a valid list of email addresses (separated by commas).',
    ...
    {'id':'isPrintable',
        ...
        'title':'Contains only printable characters',
        'errmsg':'This value contains unprintable characters.',
    ...
    {'id':'isURL',
        ...
        'title':'Is a well-formed URL',
        'errmsg':'This is not a valid url.',
        'errid':'pfg_isURL',
        'regex':r'(%s)s?://[^\s\r\n]+' % '|'.join(protocols),
        'ignore':'',
    },
    {'id':'isUSPhoneNumber',
        ...
        'title':'Is a valid US phone number',
        'errmsg':'This is not a valid us phone number.',
    ...
    {'id':'isInternationalPhoneNumber',
        ...
        'title':'Is a valid international phone number',
        'errmsg':'This is not a valid international phone number.',
    ...
    {'id':'isZipCode',
        ...
        'title':'Is a valid postal code',
        'errmsg':'This is not a valid postal code.',
        'errid':'pfg_isZipCode',
    ...
    {'id': 'isNotLinkSpam',
        ...
        'title':'Does not contain link spam',
        'errmsg':'This text appears to contain links.',
